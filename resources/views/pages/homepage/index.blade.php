...
@section('content')
    ...
    <div class="indicator">
        <nav>
            <ul>
                <li><a href="#first" class="active"><p>Our Project</p><span></span></li>
                <li><a href="#second"><p>Our Services</p><span></span></li>
                <li><a href="#third"><p>Our Products</p><span></span></li>
                <li><a href="#fourth"><p>Our Clients</p><span></span></li>
            </ul>
        </nav>
    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="text-center mb-4">
                                        <img src="{{ asset('assets/images/computer.svg') }}" class="d-block" style="margin: 0 auto 10px;" alt="">
                                        <label class="title-card">Website Development</label>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    <div class="text-center mb-4">
                                        <img src="{{ asset('assets/images/smartphone.svg') }}" class="d-block" style="margin: 0 auto 10px;" alt="">
                                        <label class="title-card">Mobile Apps Development</label>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    <div class="text-center mb-4">
                                        <img src="{{ asset('assets/images/laptop.svg') }}" class="d-block" style="margin: 0 auto 10px;" alt="">
                                        <label class="title-card">User Experiences Design</label>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    <div class="text-center mb-4">
                                        <img src="{{ asset('assets/images/world.svg') }}" class="d-block" style="margin: 0 auto 10px;" alt="">
                                        <label class="title-card">Digital Marketing</label>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    <div class="text-center mb-4">
                                        <img src="{{ asset('assets/images/video-camera.svg') }}" class="d-block" style="margin: 0 auto 10px;" alt="">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="text-center mb-4">
                                        <img src="{{ asset('assets/images/users.svg') }}" class="d-block" style="margin: 0 auto 10px;" alt="">
